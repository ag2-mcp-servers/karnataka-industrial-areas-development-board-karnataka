...
class CertificateParameters(BaseModel):
    ...
    RegNum: str = Field(
        ..., description='Registration Number', examples=['KIADB2019AL0001']
    )
...
class AlltrCertificatePostRequest(BaseModel):
...
class AlltrCertificatePostResponse(BaseModel):
...
class AlltrCertificatePostResponse1(BaseModel):
...
class AlltrCertificatePostResponse2(BaseModel):
...
class AlltrCertificatePostResponse3(BaseModel):
...
class AlltrCertificatePostResponse4(BaseModel):
...
class AlltrCertificatePostResponse5(BaseModel):
...
class AlltrCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class BknocCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class BknocCertificatePostResponse(BaseModel):
...
class BknocCertificatePostResponse1(BaseModel):
...
class BknocCertificatePostResponse2(BaseModel):
...
class BknocCertificatePostResponse3(BaseModel):
...
class BknocCertificatePostResponse4(BaseModel):
...
class BknocCertificatePostResponse5(BaseModel):
...
class BknocCertificatePostResponse6(BaseModel):
    error: Optional[Error13] = None
    errorDescription: Optional[ErrorDescription13] = None


class BpcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class BpcerCertificatePostResponse(BaseModel):
...
class BpcerCertificatePostResponse1(BaseModel):
...
class BpcerCertificatePostResponse2(BaseModel):
...
class BpcerCertificatePostResponse3(BaseModel):
...
class BpcerCertificatePostResponse4(BaseModel):
...
class BpcerCertificatePostResponse5(BaseModel):
...
class BpcerCertificatePostResponse6(BaseModel):
    error: Optional[Error20] = None
    errorDescription: Optional[ErrorDescription20] = None


class CfltrCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class CfltrCertificatePostResponse(BaseModel):
...
class CfltrCertificatePostResponse1(BaseModel):
...
class CfltrCertificatePostResponse2(BaseModel):
...
class CfltrCertificatePostResponse3(BaseModel):
...
class CfltrCertificatePostResponse4(BaseModel):
...
class CfltrCertificatePostResponse5(BaseModel):
...
class CfltrCertificatePostResponse6(BaseModel):
    error: Optional[Error27] = None
    errorDescription: Optional[ErrorDescription27] = None


class LcsagCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class LcsagCertificatePostResponse(BaseModel):
...
class LcsagCertificatePostResponse1(BaseModel):
...
class LcsagCertificatePostResponse2(BaseModel):
...
class LcsagCertificatePostResponse3(BaseModel):
...
class LcsagCertificatePostResponse4(BaseModel):
...
class LcsagCertificatePostResponse5(BaseModel):
...
class LcsagCertificatePostResponse6(BaseModel):
...
class PsnocCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class PsnocCertificatePostResponse(BaseModel):
...
class PsnocCertificatePostResponse1(BaseModel):
...
class PsnocCertificatePostResponse2(BaseModel):
...
class PsnocCertificatePostResponse3(BaseModel):
...
class PsnocCertificatePostResponse4(BaseModel):
...
class PsnocCertificatePostResponse5(BaseModel):
...
class PsnocCertificatePostResponse6(BaseModel):
    error: Optional[Error48] = None
    errorDescription: Optional[ErrorDescription48] = None


class WtrblCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class WtrblCertificatePostResponse(BaseModel):
...
class WtrblCertificatePostResponse1(BaseModel):
...
class WtrblCertificatePostResponse2(BaseModel):
...
class WtrblCertificatePostResponse3(BaseModel):
...
class WtrblCertificatePostResponse4(BaseModel):
...
class WtrblCertificatePostResponse5(BaseModel):
...
class WtrblCertificatePostResponse6(BaseModel):
